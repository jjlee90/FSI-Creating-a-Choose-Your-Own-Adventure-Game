...
n("jQeR")
n("0sPK")
var i=a["default"].scoped("ExternalToolsPlugin")
var r=n("ouhR")
var _=n.n(r)
n("gI0r")
...
const n=i.t("Apps")
const o=e.$(e.editorContainer.querySelector(`.tox-tbtn--select[aria-label="${n}"]`))
const a=e.$(e.editorContainer.querySelector(`.tox-tbtn[aria-label="${n}"]`))
if(null!==(t=window.localStorage)&&void 0!==t&&t.getItem("ltimru")){o.attr("aria-hidden","false")
a.attr("aria-hidden","true")
o.show()
a.hide()}else{o.attr("aria-hidden","true")
a.attr("aria-hidden","false")
o.hide()
a.show()}},updateMRUList(e){let t
try{var n
t=JSON.parse((null===(n=window.localStorage)||void 0===n?void 0:n.getItem("ltimru"))||"[]")}catch(e){console.log("Found bad LTI MRU data",e.message)}finally{Array.isArray(t)||(t=[])}try{if(!t.includes(e)){var o
t.unshift(e)
t.splice(s,t.length)
null===(o=window.localStorage)||void 0===o||o.setItem("ltimru",JSON.stringify(t))}}catch(e){console.log("Cannot save LTI MRU list",e.message)}}}
var d=n("dDTa")
n("q1tI")
var u=n("i8i4")
var c=n.n(u)
const w={init(e,t,a){if(!a||!a.editorButtons||!a.editorButtons.length)return
let l={open:(...e)=>setTimeout(()=>l.open(...e),50)}
Promise.all([n.e(2),n.e(3),n.e(6),n.e(19),n.e(107),n.e(4083)]).then(n.bind(null,"PrO8")).then(({default:t})=>{const n=document.createElement("div")
document.body.appendChild(n)
c.a.render(Object(o["a"])(t,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(d["a"])(),resourceSelectionUrl:_()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),n,(function(){l=this}))})
const i=[]
for(let t=0;a.editorButtons&&t<a.editorButtons.length;t++){const n=a.editorButtons[t]
const o=()=>l.open(n)
i.push(g.buttonConfig(n,e))
e.addCommand("instructureExternalButton"+n.id,o)}if(i.length){p(e,i)
f(e,i)
E(e,i)
m(e,i)}}}
...
t.icon="lti_tool_"+t.id}t.iconSVG&&e.ui.registry.addIcon(t.icon,t.iconSVG)}function m(e,t){t.length&&e.ui.registry.addNestedMenuItem("lti_tools_menuitem",{text:i.t("Apps"),icon:"lti",getSubmenuItems:()=>x(e,t)})}function p(e,t){const n=i.t("Apps")
...
e.ui.registry.addMenuButton("lti_mru_button",{tooltip:n,icon:"lti",fetch(n){n(x(e,t))},onSetup(t){g.showHideButtons(e)}})}function x(e,t){const n=[]
try{const o=JSON.parse(window.localStorage.getItem("ltimru"))
if(o&&Array.isArray(o)&&o.length){const a=t.filter(e=>o.includes(e.id))
a.forEach(t=>{h(e,t)
...
let e=Object(i["a"])(ENV.context_asset_string,false),t=Object(o["a"])(e,2),n=t[0],a=t[1]
const r=ENV.current_user_id
const _={contextType:n,contextId:a,userId:r}
const s=ENV.RICH_CONTENT_CAN_UPLOAD_FILES
if(!s||"account"===n){a=r
n="user"}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:_,contextType:n,contextId:a,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:l(ENV.JWT),themeUrl:ENV.active_brand_config_json_url}}}}])

//# sourceMappingURL=24-c-11e4de1936.js.map