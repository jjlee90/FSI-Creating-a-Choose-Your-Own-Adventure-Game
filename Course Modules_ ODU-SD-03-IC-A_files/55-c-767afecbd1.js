(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[55],{C8i9:function(e,a,t){"use strict"
var n=t("ouhR")
var i=t.n(n)
var o=t("Y/W1")
var _=t.n(o)
...
var s=t("EyBU")
t("dhbk")
var l=function(e,a){return function(){return e.apply(a,arguments)}},d=function(e,a){for(var t in a)u.call(a,t)&&(e[t]=a[t])
function n(){this.constructor=e}n.prototype=a.prototype
e.prototype=new n
e.__super__=a.prototype
return e},u={}.hasOwnProperty,c=[].slice
...
a.prototype.save=function(e,t){var n,o,_,r,l,d
null==e&&(e={})
null==t&&(t={})
if(!this.get("file"))return a.__super__.save.apply(this,arguments)
this.set(e)
n=i.a.Deferred()
l=(u=this,function(e){u.set(e)
n.resolve(e)
...
o=o.files[0]
d={name:_,on_duplicate:"rename"}
Object(s["uploadFile"])(this.preflightUrl,d,o).then(l)["catch"](r)
return n}
...
var d=t("gBVS")
function u(e){if("Network Error"===e.message){const a=new Error(l.t("Canvas failed to initiate the upload."))
a.originalError=e
...
return n.post(e,a).catch(u).then(e=>f(e.data,t,{ajaxLib:n,onProgress:o}))}function f(e,a,t={}){const o=t.ajaxLib||i["a"]
...
const s=e,l=s.upload_url,u=s.progress
if(!l)return Object(d["a"])(u,{ajaxLib:o}).catch(p)
...
return k.catch(c).then(e=>{if(u)return Object(d["a"])(u,{ajaxLib:o}).catch(p)
let a,n={}
...
//# sourceMappingURL=55-c-767afecbd1.js.map